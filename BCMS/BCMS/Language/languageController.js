...
MyApp.controller("languageController", function ($scope, $translate, $cookies) {
    ...
    $scope.switchLanguage = function (langKey) {
        ...
        //    $('link[href="/Materials/Ar/css/alerts/normalize.min.css"]').remove();
        //    $('link[href="/Materials/Ar/css/alerts/alertify.rtl.min.css"]').remove();
        //    $('link[href="/Materials/Ar/css/alerts/themes/default.min.css"]').remove();
        ...
        //    $('head').append('<link rel="stylesheet" href="/Materials/En/css/alerts/normalize.min.css" type="text/css" />');
        //    $('head').append('<link rel="stylesheet" href="/Materials/En/css/alerts/alertify.rtl.min.css" type="text/css" />');
        //    $('head').append('<link rel="stylesheet" href="/Materials/En/css/alerts/themes/default.min.css" type="text/css" />');
        //}
        //if (langKey == 'ar') {
        //    $scope.arabic = true;
        ...
        //    $('link[href="/Materials/En/css/alerts/normalize.min.css"]').remove();
        //    $('link[href="/Materials/En/css/alerts/alertify.rtl.min.css"]').remove();
        //    $('link[href="/Materials/En/css/alerts/themes/default.min.css"]').remove();
        ...
        //    $('head').append('<link rel="stylesheet" href="/Materials/Ar/css/alerts/normalize.min.css" type="text/css" />');
        //    $('head').append('<link rel="stylesheet" href="/Materials/Ar/css/alerts/alertify.rtl.min.css" type="text/css" />');
        //    $('head').append('<link rel="stylesheet" href="/Materials/Ar/css/alerts/themes/default.min.css" type="text/css" />');
        //}
